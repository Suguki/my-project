    ...
    <div claaa="row">
      <div class="col-md-12 h-100 parallel">
        <ul class="col-md-12">
          ...
          <p class="space">
            学生時代の部活動<br>
            ・中高6年間を通してソフトテニス部に所属し、中学では団体で京都府優勝、高校では個人戦で市内ベスト4の実績があります。<br>
            ・中学では全国大会出場経験のあるジュニア選手が半数を占める中未経験で入部し、3年生でレギュラー入りし上記の実績を
            残すことができました。<br>
            ・実績を残すことができた理由にもつながるのですが、一度熱が入ると一日中そのことについて考えるタイプであることが
            強みです。<br>
          </p>
          <br />
          <li>
